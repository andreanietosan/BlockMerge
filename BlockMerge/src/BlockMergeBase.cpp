...
void pruebasDelTablero(){
	pruebaIniciarTablero();
	pruebaObtenerTamReal();
	pruebaPonerValorTablero();
	pruebaVaciarCasillaTablero();
	pruebaEstaVaciaCasilla();
	pruebaObtenerValorCasilla();
	pruebaEsBloqueCasillaTablero();
	pruebaHayBloques();
	pruebaObtenerValorMax();
	pruebaVaciarBloqueCasillaTablero();
	pruebaDesplazarVaciasColumna();
	pruebaDesplazarTodasColumnas();
	pruebaRellenarPorArribaColumnaVacia();
	pruebaRellenarTodasColumnas();
